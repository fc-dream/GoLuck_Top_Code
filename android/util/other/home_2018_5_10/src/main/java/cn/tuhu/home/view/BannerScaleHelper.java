...
public class BannerScaleHelper {
    ...
    private int mPagePadding = CardAdapterHelper.mPagePadding; // 卡片的padding, 卡片间的距离等于2倍的mPagePadding
...
//    private CardLinearSnapHelper mLinearSnapHelper = new CardLinearSnapHelper();
    private CardScaleLeftSnapHelper mLinearSnapHelper = new CardScaleLeftSnapHelper();
    private int mLastPos;

    public void attachToRecyclerView(final SpeedRecyclerView mRecyclerView) {
